 ...
 *******************************************************************************/
package au.org.intersect.exsite9.view.dialogs;
 ...
 * Taken from the Eclipse SDK so we can provide a search facility that looks for matches anywhere in the provided fields.
 * @see #createFilterText(Composite)
 */
    ...
    protected Text createFilterText(Composite parent) {
        ...
        Listener listener = new Listener() {
            public void handleEvent(Event e) {
                // Added "*" in front of the filter text, so we can search the whole String for matches
                // i.e. not just from the beginning.
