...
public final class Project implements Serializable
{
    ...
    @JoinTable(name = "project_folder", joinColumns = {@JoinColumn(name = "project_id", referencedColumnName = "id")}, inverseJoinColumns = {@JoinColumn(name = "folder_id", referencedColumnName = "id")})
    ...
    public Project(ProjectFieldsDTO projectFields)
    {
